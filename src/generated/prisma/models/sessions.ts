...
export type sessionsWhereInput = {
  ...
  refresh_token?: Prisma.StringFilter<"sessions"> | string
  ...
  expires_at?: Prisma.DateTimeNullableFilter<"sessions"> | Date | string | null
...
export type sessionsScalarWhereWithAggregatesInput = {
  ...
  refresh_token?: Prisma.StringWithAggregatesFilter<"sessions"> | string
  ...
  expires_at?: Prisma.DateTimeNullableWithAggregatesFilter<"sessions"> | Date | string | null
}
...
export type sessionsOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"refresh_token" | "user_id" | "created_at" | "user_agent" | "expires_at", ExtArgs["result"]["sessions"]>
...
export interface sessionsDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const sessionsWithRefresh_tokenOnly = await prisma.sessions.findMany({ select: { refresh_token: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Sessions and only return the `refresh_token`
   * const sessionsWithRefresh_tokenOnly = await prisma.sessions.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Sessions and only return the `refresh_token`
   * const sessionsWithRefresh_tokenOnly = await prisma.sessions.updateManyAndReturn({
   *   select: { refresh_token: true },
   *   where: {
   *     // ... provide filter here
   *   },
